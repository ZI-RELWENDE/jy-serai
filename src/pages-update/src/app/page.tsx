  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0a0a0a", color: "#fff", fontFamily: "sans-serif" }}>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16, maxWidth: 900, margin: "0 auto", padding: "0 24px 80px" }}>
        {[
          { icon: "F", title: "Cadres PNG transparents", desc: "Upload ton cadre en PNG, il s applique par-dessus la photo." },
          { icon: "C", title: "Recadrage circulaire", desc: "Decoupe ta photo en cercle pour un rendu professionnel." },
          { icon: "T", title: "Texte personnalise", desc: "Ajoute ton prenom ou un message sur le visuel." },
          { icon: "P", title: "Partage direct", desc: "Telecharge en haute resolution, pret pour WhatsApp." },
        ].map((f) => (
